...
def welcomepic(pic, user, chat, id, uname):
    ...
    font = ImageFont.truetype('AnonXMusic/SwanseaBold-D0ox.ttf', size=40)
    welcome_font = ImageFont.truetype('AnonXMusic/SwanseaBold-D0ox.ttf', size=60)
